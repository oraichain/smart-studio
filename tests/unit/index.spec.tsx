  ...
  describe('init', () => {
    ...
    it('should render <App /> with the correct params (?f=fiddle-uri)', async () => {
      ...
      expect(ReactDOM.render).toHaveBeenCalledWith(
        <ErrorBoundary>
          <App embeddingParams={{ templatesName: 'default', type: 0 }} fiddle="fiddle-uri" update={false} windowContext={{ promptWhenClosing: false }} />
        </ErrorBoundary>,
    ...
    it('should render <App /> with the correct params (?update)', async () => {
      ...
      expect(ReactDOM.render).toHaveBeenCalledWith(
        <ErrorBoundary>
          <App embeddingParams={{ templatesName: 'default', type: 0 }} fiddle={undefined} update={true} windowContext={{ promptWhenClosing: false }} />
        </ErrorBoundary>,
        document.getElementById('app')
      );
    });
