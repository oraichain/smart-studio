...
describe('Tests for NewDirectoryDialog', () => {
  const setup = (params: { onCreate?: (directory: Directory) => void; onCancel?: () => void }) => {
    // tslint:disable-next-line
    const nop = () => {};
    return shallow(<NewDirectoryDialog isOpen={true} directory={getDirectory()} onCancel={params.onCancel || nop} onCreate={params.onCreate || nop} />);
  };
