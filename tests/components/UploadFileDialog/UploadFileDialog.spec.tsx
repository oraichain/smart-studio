...
describe('Tests for UploadFileDialog', () => {
  const setup = ({
    ...
    const wrapper = shallow(<UploadFileDialog isOpen={isOpen} directory={directory} onUpload={onUpload} onCancel={onCancel} />);
    return {
      wrapper,
      addFiles() {
  ...
  it('should invoke onUpload when clicking the additional upload button', () => {
    ...
    wrapper
      .find(Button)
      .at(ButtonIndex.UploadRootContents)
      .simulate('click');
